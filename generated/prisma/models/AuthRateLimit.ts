...
export type AuthRateLimitWhereInput = {
  ...
  category?: Prisma.StringFilter<"AuthRateLimit"> | string
  count?: Prisma.IntFilter<"AuthRateLimit"> | number
  windowStartedAt?: Prisma.DateTimeFilter<"AuthRateLimit"> | Date | string
...
export type AuthRateLimitScalarWhereWithAggregatesInput = {
  ...
  category?: Prisma.StringWithAggregatesFilter<"AuthRateLimit"> | string
  count?: Prisma.IntWithAggregatesFilter<"AuthRateLimit"> | number
  windowStartedAt?: Prisma.DateTimeWithAggregatesFilter<"AuthRateLimit"> | Date | string
...
export type AuthRateLimitOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "category" | "count" | "windowStartedAt" | "blockedUntil" | "expiresAt" | "updatedAt", ExtArgs["result"]["authRateLimit"]>
...
export interface AuthRateLimitDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const authRateLimitWithKeyOnly = await prisma.authRateLimit.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AuthRateLimits and only return the `key`
   * const authRateLimitWithKeyOnly = await prisma.authRateLimit.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more AuthRateLimits and only return the `key`
   * const authRateLimitWithKeyOnly = await prisma.authRateLimit.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AuthRateLimitFieldRefs {
  ...
  readonly category: Prisma.FieldRef<"AuthRateLimit", 'String'>
  readonly count: Prisma.FieldRef<"AuthRateLimit", 'Int'>
  readonly windowStartedAt: Prisma.FieldRef<"AuthRateLimit", 'DateTime'>
